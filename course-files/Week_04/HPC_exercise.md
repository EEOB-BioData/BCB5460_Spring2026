...
Once you have successfully logged on, `cd` into your `BCB5460_Spring2026` folder and update the folder using the command:
...
`$ sbatch /home/mhufford/BCB5460_Spring2026/course-files/Week_04/blastn.sh`
