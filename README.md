# EEOB/BCB5460 Spring 2026 Course Repository
...
First, navigate to the directory that you would like to store the course repository, for example, you might want to keep all of the material for this course in a folder called `BCB5460_2026` on your desktop:

```
cd Desktop/BCB5460_2026
```

Now, you can clone the repository:

```
git clone git@github.com:EEOB-BioData/BCB5460_Spring2026.git
```
